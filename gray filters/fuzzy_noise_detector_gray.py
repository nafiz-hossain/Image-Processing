...
if __name__ == "__main__":
    ...
    for p in noise_percentages:
        ...
        util.plot_graphs(p, 'fuzzy_noise_detector', final_img, iterations, mse_values, psnr_values, duration_arr)
    ...
    util.write_csv('fuzzy_noise_detector', noise_percentages, mse_with_noises, psnr_with_noises, duration_with_noises)
